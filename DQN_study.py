...
class pendulumEnvironment():
    ...
    '''
    def __init__(self):
        self.env = wrappers.Monitor(gym.make('CartPole-v0'), './private/tmp/cartpole-experiment-3', force = True)　#　変更
...
if __name__ == '__main__':
    ...
    env.monitor_close()
    gym.upload('./private/tmp/cartpole-experiment-3', api_key='own_api_key')
